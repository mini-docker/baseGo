...
var tasksDoneFlag *atomicbool.AtomicBool
var tasksWaiting chan bool
var tasksWaitingFlag *atomicbool.AtomicBool
...
func init() {
	...
	tasksDoneFlag = atomicbool.NewBool(true)
	tasksWaiting = make(chan bool, 1)
	tasksWaitingFlag = atomicbool.NewBool(false)
