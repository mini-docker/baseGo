...
func (l *Logic) OnlineTop(c echo.Context, typ string, n int) (tops []*model.Top, err error) {
...
func (l *Logic) OnlineRoom(c echo.Context, typ string, rooms []string) (res map[string]int32, err error) {
