...
func (b *DefaultBinder) Bind(i interface{}, c Context) (err error) {
	...
	case strings.HasPrefix(ctype, MIMEApplicationProtobuf): // in body .
		reply, err := ioutil.ReadAll(req.Body)
		if err != nil {
			return ErrUnsupportedMediaType
		}
		return proto.Unmarshal(reply, i.(proto.Message))
	case strings.HasPrefix(ctype, MIMETextPlain):
		reply, err := ioutil.ReadAll(req.Body)
		if err != nil {
			return ErrUnsupportedMediaType
		}
		return json.Unmarshal(reply, i)
	default:
		return ErrUnsupportedMediaType
	}
	return
