...
type (
	...
	Renderer interface {
		Render(io.Writer, string, map[string]interface{}, Context) error
		RenderSub(w io.Writer, tt, name string, data map[string]interface{}, c Context) error
		WapRender(w io.Writer, name string, data map[string]interface{}, c Context) error
		WapRenderSub(w io.Writer, name string, data map[string]interface{}, c Context) error
	}
...
func (e *Echo) DefaultHTTPErrorHandler(err error, c Context) {
	...
	if !c.Response().Committed {
		...
		if err != nil {
			golog.Error("echo", "DefaultHTTPErrorHandler", "error %s", err)
		}
	}
}
