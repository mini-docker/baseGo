...
func (ss *SessionService) GetSession(sessionIdFull string) (*model.UserSession, error) {
	// 获取session数据
...
func (ss *SessionService) SaveSession(listKey string, session *model.UserSession) error {
	if session == nil {
