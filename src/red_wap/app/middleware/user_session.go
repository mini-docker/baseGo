...
func (ss *UserSessionService) GetSession(sessionIdFull string) (*model.UserSession, error) {
...
func (ss *UserSessionService) SaveSession(listKey string, session *model.UserSession) error {
	if session == nil {
